...
V = {
    0: ("PARTIALLY_SUPPORTED", "CITATION", "NOT_IN_SOURCE", "TIER_OK", "OK", "OK",
    ...
    1: ("PARTIALLY_SUPPORTED", "MIXED", "NOT_IN_SOURCE", "NOT_DEFENSIBLE_AS_RECORDED", "OK", "OK",
        ...
        "stands."),
    2: ("SUPPORTED", "CITATION", "SOURCE_STATES_IT", "TIER_SHOULD_BE_t1v", "OK", "HIGH_TO_MEDIUM",
    ...
    3: ("PARTIALLY_SUPPORTED", "MIXED", "NOT_IN_SOURCE", "TIER_SHOULD_BE_t3", "OK",
        "HIGH_TO_MEDIUM",
    ...
    4: ("SUPPORTED", "CITATION", "NOT_IN_SOURCE", "TIER_OK", "OK", "OK",
    ...
    5: ("SUPPORTED", "CITATION", "NOT_IN_SOURCE", "TIER_SHOULD_BE_t3", "OK", "HIGH_TO_MEDIUM",
    ...
    6: ("SUPPORTED", "CITATION", "SOURCE_STATES_IT", "TIER_OK", "OK", "OK",
        ...
        "hits in 29 pages."),
    7: ("SUPPORTED", "CITATION", "SOURCE_STATES_IT", "TIER_OK", "IN_UNEARNED", "OK",
    ...
    8: ("PARTIALLY_SUPPORTED", "MIXED", "SOURCE_STATES_IT", "TIER_OK", "IN_UNEARNED", "OK",
    ...
    9: ("PARTIALLY_SUPPORTED", "JUDGMENT", "NOT_IN_SOURCE", "TIER_OK", "IN_WRONG", "OK",
    ...
    10: ("SUPPORTED", "CITATION", "PARTIAL", "TIER_OK", "IN_WRONG", "OK",
    ...
    11: ("SUPPORTED", "CITATION", "NOT_IN_SOURCE", "TIER_OK", "OK", "HIGH_TO_MEDIUM",
    ...
    12: ("SUPPORTED", "CITATION", "SOURCE_STATES_IT", "TIER_OK", "OK", "OK",
    ...
    13: ("SUPPORTED", "MIXED", "NOT_IN_SOURCE", "TIER_OK", "OK", "OK",
    ...
    14: ("PARTIALLY_SUPPORTED", "JUDGMENT", "NOT_IN_SOURCE", "TIER_OK", "OK", "HIGH_TO_MEDIUM",
    ...
    15: ("PARTIALLY_SUPPORTED", "MIXED", "PARTIAL", "TIER_OK", "OK", "OK",
    ...
    16: ("SUPPORTED", "JUDGMENT", "NOT_IN_SOURCE", "TIER_SHOULD_BE_t3", "OK", "HIGH_TO_MEDIUM",
    ...
    17: ("SUPPORTED", "JUDGMENT", "SOURCE_STATES_IT", "TIER_OK", "OK", "MEDIUM_TO_LOW",
    ...
    18: ("PARTIALLY_SUPPORTED", "JUDGMENT", "NOT_IN_SOURCE", "TIER_OK", "OK", "MEDIUM_TO_LOW",
    ...
    19: ("PARTIALLY_SUPPORTED", "MIXED", "NOT_IN_SOURCE", "TIER_OK", "OK", "HIGH_TO_MEDIUM",
    ...
    20: ("NOT_FOUND", "JUDGMENT", "NOT_IN_SOURCE", "CARD_CANNOT_INHERIT_TIER", "OK",
         "INDEFENSIBLE",
         ...
         "actually reports."),
    21: ("SUPPORTED", "CITATION", "SOURCE_STATES_IT", "TIER_OK", "OK", "OK",
    ...
    22: ("SUPPORTED", "CITATION", "SOURCE_STATES_IT", "TIER_SHOULD_BE_t3", "OK", "HIGH_TO_MEDIUM",
    ...
    23: ("SUPPORTED", "CITATION", "SOURCE_STATES_IT", "TIER_OK_CONDITIONAL", "OK",
         "HIGH_TO_MEDIUM",
         ...
         "significant."),
    24: ("PARTIALLY_SUPPORTED", "JUDGMENT", "NOT_IN_SOURCE", "TIER_OK", "OK", "OK",
         ...
         "ad-trade marketing."),
    25: ("SUPPORTED", "JUDGMENT", "SOURCE_STATES_IT", "TIER_OK", "OK", "OK",
    ...
    26: ("PARTIALLY_SUPPORTED", "MIXED", "NOT_IN_SOURCE", "CARD_CANNOT_INHERIT_TIER", "OK",
         "INDEFENSIBLE",
    ...
    27: ("SUPPORTED", "CITATION", "NOT_IN_SOURCE", "TIER_OK", "OK", "OK",
    ...
    28: ("PARTIALLY_SUPPORTED", "JUDGMENT", "NOT_IN_SOURCE", "TIER_SHOULD_BE_t3", "OK",
         "INDEFENSIBLE",
    ...
    29: ("PARTIALLY_SUPPORTED", "JUDGMENT", "PARTIAL", "WRONG_ARTIFACT", "OK", "INDEFENSIBLE",
    ...
    30: ("SUPPORTED", "CITATION", "NOT_IN_SOURCE", "TIER_OK", "OK", "OK",
    ...
    31: ("SUPPORTED", "MIXED", "SOURCE_CONCLUSION_CONTRADICTS", "TIER_OK", "OK", "OK",
    ...
    32: ("PARTIALLY_SUPPORTED", "MIXED", "NOT_IN_SOURCE", "TIER_OK", "IN_WRONG", "OK",
...
UNSOUND = {
    "bk019-bulky-product-shipping-unit-economics-local-first":
        "Both qualifying clusters fail: the USPS tariff is US-specific and non-transferable, and "
    ...
    "bk031-partner-network-co-selling-borrows-trust":
        "The two 'independent' clusters are Cai & Szeidl field experiments in the same Chinese "
    ...
    "bk032-brand-memory-proof-and-promise":
        "Both clusters are opinion posts: a 5-paragraph blog deferring to a book, and a blog post "
        "that is not the report its URL names. Neither carries the memory/proof/promise content.",
}


def main() -> int:
    cards = [json.loads(line) for line in (CORPUS / "t4_corroboration_candidates.jsonl")
             .read_text(encoding="utf-8").splitlines() if line]
    sources = [json.loads(line) for line in (CORPUS / "t4_corroboration_sources.jsonl")
               .read_text(encoding="utf-8").splitlines() if line]
    ...
    for index, artifact in enumerate(cards):
        ...
        rows.append({
            ...
            "claim_verdict": claim,
            "vanish_verdict": vanish,
            "action_in_source": action,
            "tier_verdict": tier,
            "jurisdiction_verdict": juris,
            "confidence_verdict": conf,
    ...
    unsound.write_text(json.dumps(UNSOUND, indent=2, sort_keys=True) + "\n", encoding="utf-8")

    grade = sum(1 for row in rows if row["landing_grade"])
    print(f"wrote {out.name}: {grade} of {len(rows)} landing-grade")
    for label, key in (
        ...
        bad = [row["index"] for row in rows if row[key] not in {"SUPPORTED", "CITATION", "TIER_OK", "OK"}]
