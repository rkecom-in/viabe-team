...
The spine the six specialist lanes plug into (design §7). It makes adding a
specialist CHEAP: a sub-graph + ONE ``SpecialistSpec`` entry — not 4 edits
across 3 files (handoffs + routing + graph node + graph edge).
