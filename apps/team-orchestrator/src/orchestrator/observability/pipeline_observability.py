...
def write_step(
    *,
    ...
    # 3. PII redaction (CL-104)
    input_envelope_safe = redact_for_log(input_envelope) if input_envelope else {}
    output_envelope_safe = (
        redact_for_log(output_envelope) if output_envelope else None
    )
